...
/** 首页只展示欢迎语、本机运行时和设备信息，业务资源统一进入对应一级页面。 */
        ...
        <Card>
          <CardContent className="flex flex-wrap items-center justify-between gap-3 p-3">
            <div>
              ...
              <h1 className="text-base font-semibold text-slate-800">{greeting}，开始工作</h1>
              <p className="mt-1 text-xs text-slate-500">保持专注，准备开始今天的工作。</p>
